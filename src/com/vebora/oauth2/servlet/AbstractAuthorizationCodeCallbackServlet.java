 ...
 * <p>
 * This is designed to simplify the flow in which an end-user authorizes your web application to access their protected data. The main servlet class extends {@link AbstractAuthorizationCodeServlet}
 * which if the end-user credentials are not found, will redirect the end-user to an authorization page. If the end-user grants authorization, they will be redirected to this servlet that extends
 * {@link AbstractAuthorizationCodeCallbackServlet} and the {@link #onSuccess} will be called. Similarly, if the end-user grants authorization, they will be redirected to this servlet and
 * {@link #onError} will be called.
 * </p>
 * <p>
 * Sample usage:
 * </p>
...
public abstract class AbstractAuthorizationCodeCallbackServlet extends HttpServlet
{
			...
			throws ServletException, IOException
	{
		...
		} else
		{
			...
			try
			{
				...
				onSuccess(req, resp, credential, userId);
			} finally
			{
				lock.unlock();
			}
	 ...
	 *             some I/O exception
	 */
	protected void onSuccess(HttpServletRequest req, HttpServletResponse resp, Credential credential, String userId)
			throws ServletException, IOException
	{
	}
	 ...
	 *            HTTP servlet response
	 * @param errorResponse
	 *            error response ({@link AuthorizationCodeResponseUrl#getError()} is not {@code null})
	 * @throws ServletException
	 *             HTTP servlet exception
	 * @throws IOException
	 *             some I/O exception
